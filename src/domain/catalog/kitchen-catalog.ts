...
const rawKitchenEquipment = [
  ...
  entry({ id: 'waste-mobile-bin', familyId: 'waste-bin', name: 'Mobile trash / waste bin', category: 'waste-janitorial', description: 'Lidded wheeled bin for general kitchen waste collection.', synonyms: ['wheelie bin', 'trash bin', 'garbage can', 'refuse bin'], dimensions: { widthMm: 600, depthMm: 700, heightMm: 1000 }, capabilities: ['waste-collection'], concurrentUnits: 1, storageLitres: 240, clearanceKind: 'none', tags: ['mobile', 'waste', 'lidded'], constructorKey: 'waste-mobile-bin' }),
