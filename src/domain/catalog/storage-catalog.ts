...
const rawStorageCatalog = [
  ...
  storageEntry({ id: 'storage-overshelf', familyId: 'shelving-overshelf', name: 'Table overshelf', description: 'One- or two-tier overshelf mounted above a preparation or service table.', synonyms: ['overshelf', 'table shelf', 'chef shelf'], dimensions: { widthMm: 1200, depthMm: 350, heightMm: 700 }, minimum: { widthMm: 600, depthMm: 250, heightMm: 450 }, maximum: { widthMm: 2400, depthMm: 450, heightMm: 1200 }, capabilities: ['elevated-storage', 'pass-storage'], capacity: { workPositions: 0, concurrentUnits: 16, storageLitres: 150 }, mounting: 'overhead', clearanceFrontMm: 0, configurationIds: ['overshelf-one-tier', 'overshelf-two-tier'], tags: ['overhead', 'elevated', 'table-mounted'], constructorKey: 'storage-overshelf' }),
  storageEntry({ id: 'storage-freestanding-shelving', familyId: 'shelving-floor', name: 'Freestanding shelving', description: 'Adjustable multi-tier floor shelving for dry goods, utensils, and smallwares.', synonyms: ['wire shelving', 'dry store shelf', 'shelf unit'], dimensions: { widthMm: 1200, depthMm: 500, heightMm: 1800 }, minimum: { widthMm: 600, depthMm: 350, heightMm: 1200 }, maximum: { widthMm: 2400, depthMm: 700, heightMm: 2400 }, capabilities: ['dry-storage'], capacity: { workPositions: 0, concurrentUnits: 40, storageLitres: 900 }, mounting: 'floor', clearanceFrontMm: 800, configurationIds: ['shelving-four-tier', 'shelving-five-tier', 'shelving-six-tier'], tags: ['floor-mounted', 'shelving', 'adjustable'], constructorKey: 'storage-freestanding-shelf' }),
